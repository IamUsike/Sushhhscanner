...
class SensitiveDataDetector {
    ...
    scan(content, context = 'unknown') {
        ...
        for (const [key, patternInfo] of Object.entries(SensitiveDataDetector.PATTERNS)) {
            ...
            while ((match = patternInfo.regex.exec(content)) !== null) {
                ...
                logger_1.logger.warn(`Sensitive data detected: ${patternInfo.type} in ${context}. Match: ${match[0].substring(0, 50)}...`);
            }
        }
        return findings;
    }
     ...
     */
    static findingsToVulnerabilities(findings, endpoint, method) {
...
SensitiveDataDetector.PATTERNS = {
    EMAIL_ADDRESS: {
